...
@session_start();
/**
 * https://www.youdomain.com/modules/gateways/wanyi/notify.php
 */
...
function wanyialipay_link($params)
{
    # 网关变量
...
//    }
    ...
    $icon = "{$systemurl}/modules/gateways/wanyi/alipaybtn.png";
    $code = "<a href=\"{$link}\"><img src=\"{$icon}\" class=\"rounded\" target='_blank' alt=\"点击使用支付宝支付\" style='max-width: 200px;'></a>";
    return $code;
}
